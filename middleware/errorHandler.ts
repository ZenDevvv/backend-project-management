...
// This function will handle errors based on the HTTP status code
// It will return a JSON object with the error title, message and the stack trace
// If the status code is not defined, it will return a default error message
